...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 bg-popover text-popover-foreground shadow-md rounded-lg", className)}
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50",
